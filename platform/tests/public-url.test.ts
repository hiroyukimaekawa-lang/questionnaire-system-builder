...
test('公開URLはNEXT_PUBLIC_APP_URL相当のbaseとcanonical /s/slugを使う',()=>assert.equal(publicSurveyUrl('https://questionnaire.example/','sample'),'https://questionnaire.example/s/sample'));
