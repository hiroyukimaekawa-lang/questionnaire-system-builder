import test from 'node:test';import assert from 'node:assert/strict';import {completionRulesSchema,googleReviewRuleSchema,parseCompletionRulesJson,parseGoogleReviewRuleJson,validateGoogleReviewRuleForQuestions,validateRulesForQuestions} from '../lib/completion-validation';import type {SurveyQuestion} from '../types/database';
const makeQuestion=(id:string,maxScore:5|10,sortOrder=0):SurveyQuestion=>({id,type:'rating_10',title:'score',description:'',required:true,sortOrder,settings:{maxScore},options:[]});const id='11111111-1111-4111-8111-111111111111',id2='22222222-2222-4222-8222-222222222222',id3='33333333-3333-4333-8333-333333333333';
