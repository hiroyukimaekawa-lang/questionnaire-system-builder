-- Preserve server-computed review eligibility and the one-time Google Sheets sync token.
-- Both values are generated by the server. The function still whitelists and validates
-- every metadata field before storing it.
