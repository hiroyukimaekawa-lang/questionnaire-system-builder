...
// SUPABASE_SERVICE_ROLE_KEY is a Runtime Secret only (never a Build Variable), so it is not present during Cloudflare Workers Builds and must not be checked here. createAdminClient() enforces it at runtime.
